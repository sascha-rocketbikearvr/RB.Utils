...
namespace RB.Utils {
    public static class SerializationUtils2 {
        ...
        public class SerializableMemberInfo {
                    ...
                    if (_memberInfo == null && _name != null && _type != null) {
                        switch (_memberType) {
                            ...
                            case MemberTypes.Method:
                                _memberInfo = _type.Type.GetMethod(_name);
                                break;
                            case MemberTypes.Event:
                                _memberInfo = _type.Type.GetEvent(_name);
                                break;
                            default:
                                return null;
                        }
            ...
            public EventInfo ActionEventInfo {
                get {
                    if (_memberType == MemberTypes.Event) {
                        return (EventInfo)MemberInfo;
                    }
                    return null;
                }
                set {
            ...
            public Type MemberType {
                get {
                    switch (_memberType) {
                        ...
                        case MemberTypes.Method:
                            return SetterMethodInfo.GetParameters()[0].ParameterType;
                        default:
            ...
            public object GetValue(object obj) {
                switch (_memberType) {
                    ...
                    //case MemberTypes.Method: // fallthrough intended
                    //case MemberTypes.Event:
                    //	return obj;
                    default:
                        throw new ArgumentException();
            ...
            public void SetValue(object obj, object value) {
                switch (_memberType) {
                    ...
                    case MemberTypes.Property:
                        ...
                        break;
                    case MemberTypes.Method:
                        SetterMethodInfo.Invoke(obj, new object[] { value });
                        break;
                    //case MemberTypes.Event: // do nothing
                    //	break;
                    default:
                        throw new ArgumentException();
                }
